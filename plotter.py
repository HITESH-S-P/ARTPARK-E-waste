...
<style>
    ...
    /* 'X' (delete) button on the file pill */
    ...
    /* ---------- ALERTS & PROGRESS (FIXED) ---------- */
    .stAlert {
        border-radius: 8px;
        padding: 1rem;
    }
    /* Style for SUCCESS alert */
    div[data-testid="stAlert"][data-baseweb="alert-positive"] {
        background-color: var(--light-green);
    }
    div[data-testid="stAlert"][data-baseweb="alert-positive"] p {
        color: var(--dark-green) !important; /* Dark green text for contrast */
    }
    /* Style for INFO alert */
    div[data-testid="stAlert"][data-baseweb="alert-info"] {
        background-color: #eaf0f6; /* A light, complementary blue */
    }
    div[data-testid="stAlert"][data-baseweb="alert-info"] p {
        color: var(--accent-blue) !important; /* Dark blue text */
    }
    /* Style for WARNING alert */
    div[data-testid="stAlert"][data-baseweb="alert-warning"] {
        background-color: #fffbeb; 
    }
     div[data-testid="stAlert"][data-baseweb="alert-warning"] p {
        color: #92400e !important;
    }
    /* Style for ERROR alert */
    div[data-testid="stAlert"][data-baseweb="alert-negative"] {
        background-color: #feefee;
    }
    div[data-testid="stAlert"][data-baseweb="alert-negative"] p {
